...
<html>
  <head>
	...
	function add(){
		$.post("parmeters/toadd.do",{},function(data){
			//$("#objdiv").show();
	...
	function toPage(p){
		...
		if(p<=0||p>total){
  		...
  		document.frm.action="parmeters/list.do";
 	...
 	<div class="tai_right" id="tai_right">
    	...
    	<table width="100%" class="table-ellipsis">
          <tr class="back_tit">
            ...
            <td style="width:5%;">参数1 loginame</td>
            <td style="width:10%;">参数2 loginpass</td>
            <td style="width:10%;"><a href="javascript:void(0)" onclick="add()"><font color="#fc7305"><b>添加</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;操作</td>
          </tr>
         ...
         <tr class="hang01">
		    ...
		    <input type="button" class="gaic" value="删除" onclick="window.location.href='<%=path %>/parmeters/delete.do?Id=${o.uid }'">
		    </td>
		    </tr>
		    </c:forEach>
        </table><br>
